...
| 이미지                                                                                     | 설명                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Image1](https://github.com/user-attachments/assets/6297c642-e831-4489-84a7-3ff251943f24) | - 사용자는 "업로드 영역"을 클릭하여 파일을 선택하거나 드래그하여 파일을 업로드 할 수 있습니다. </br></br> - "사용 방법 안내"를 통해 사용자에게 간단한 사용법을 제공합니다.                                                                                                                                                                                                                     |
| ![Image2](https://github.com/user-attachments/assets/75f42c2f-289e-482b-b3fa-9f44d7d56d8e) | - 업로드된 파일은 화살표 클릭, 마우스 클릭, 방향키 조작을 통해 각 페이지를 확인할 수 있습니다. </br></br> - "Go to Presentation!" 버튼을 클릭하면 발표자 페이지가 새 탭에서 열리며, 청중 페이지는 발표에 사용할 디바이스로 이동 후 사용할 수 있습니다.                                                                                                                                         |
| ![Image3](https://github.com/user-attachments/assets/a45efc74-71ea-4219-ba1f-1bf3f0fe26d9) | **발표자 페이지** </br></br> - 화면 왼쪽 상단에는 타이머 기능이 제공되며, Pause 및 Reset 버튼을 통해 일시정지와 초기화가 가능합니다. </br></br> - 각 PDF 페이지마다 메모를 작성하고 저장하여, 발표자가 필요한 정보를 잊지 않고 전달할 수 있도록 도와줍니다.                                                                                                                                    |
| ![Image4](https://github.com/user-attachments/assets/4e62ed14-a1cf-491f-b8b5-5b35fb90d84d) | **좌: 청중페이지, 우: 발표자 페이지** </br></br> - 화면 중앙에 위치한 PDF 페이지만 청중 페이지에 노출됩니다. (이 영역을 ‘뷰어 섹션’이라 칭합니다.) </br></br> - 뷰어 섹션에 마우스를 이동하면, 청중의 집중을 돕기 위해 청중 페이지에서도 마우스 포인터가 동일하게 이동합니다. </br></br> - 펜 및 지우개 버튼을 사용하여 뷰어 섹션 내에서 드로잉을 추가하거나 삭제할 수 있는 기능을 제공합니다. |
